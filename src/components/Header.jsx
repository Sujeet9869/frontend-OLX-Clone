...
import { FaSearch, FaTumblr } from "react-icons/fa";
                ...
                {showOver && <div style={{
                    ...
                    <div>
                        ...
                        {!!localStorage.getItem('token') &&
                            <Link className="links" to="/add-product">
                                <button className="logout-btn">Add Product</button></Link>}
                    </div>
                    ...
                    <div>
                        ...
                        {!!localStorage.getItem('token') &&
                            <Link className="links" to="/Liked-products">
                   ...
                   {!!localStorage.getItem('token') &&
                   <Link className="links" to="/my-products">
